...
curl -sO https://raw.githubusercontent.com/ChairBorn/JimsGarage/refs/heads/main/Kubernetes/K3S-Deploy/kube-vip
...
curl -sO https://github.com/ChairBorn/JimsGarage/blob/main/Kubernetes/K3S-Deploy/ipAddressPool
